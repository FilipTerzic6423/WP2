      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
          <ul class="navbar-nav mx-auto gap-1">
            ...
            <li class="nav-item">
              <a class="nav-link ${activePage === 'home' ? 'active' : ''}" href="author.html">Author</a>
            </li>
          </ul>
...
function renderBookCard(book) {
  ...
  if (book.badge) {
    ...
    if (book.badge === 'Sale') badgeClass = 'badge-sale';
    else if (book.badge === 'Classic') badgeClass = 'badge-classic';
    else if (book.badge === 'Bestseller') badgeClass = 'badge-best';
    else if (book.badge === 'Award Winner') badgeClass = 'badge-award';
    else if (book.badge === 'New') badgeClass = 'badge-new';
      ...
      <div class="book-card">
        <div class="book-cover-wrap">
          ...
          <img src="${book.cover}" alt="${book.title}" class="book-cover"
               onerror="this.src='https://placehold.co/300x420/5c3d2e/f5e6c8?text=No+Cover'">
          <div class="cover-overlay">
            <p class="book-desc-preview">${book.description.substring(0, 100)}...</p>
          </div>
        </div>
        <div class="book-info">
